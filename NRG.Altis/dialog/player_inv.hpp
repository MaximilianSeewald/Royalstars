...
class playerSettings {
	...
	class controls {
		...
		class ButtonCell_ICON: life_RscPicture
		{
			...
			x = 0.5419941 * safezoneW + safezoneX;
			y = 0.7016 * safezoneH + safezoneY;
			w = 0.028875 * safezoneW;
			h = 0.0504 * safezoneH;
		};
		...
		class ButtonPerso_ICON: life_RscPicture
		{
			idc = 3028;
			text = "textures\tablet\perso.paa";
			x = 0.6640668 * safezoneW + safezoneX;
			y = 0.7016 * safezoneH + safezoneY;
			w = 0.028875 * safezoneW;
			h = 0.0504 * safezoneH;
		};
		class ButtonPerso: life_RscButtonMenu
		{
			idc = 3027;
			x = 0.6640668 * safezoneW + safezoneX;
			y = 0.7016 * safezoneH + safezoneY;
			...
			tooltip = "Personalausweis ansehen";
			colorBackground[] = {-1,-1,-1,-1};
			colorBackgroundFocused[] = {1,1,1,0.12};
			colorBackground2[] = {0.75,0.75,0.75,0.2};
			color[] = {1,1,1,1};
